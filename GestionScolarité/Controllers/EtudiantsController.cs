...
namespace GestionScolarité.Controllers
{
    public class EtudiantsController : Controller
    {
       ...
       [HttpPost]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Editt([Bind(Include = "Id,Status,Nom,Prenom,Role,Mail,Password")] Etudiant etudiant)
        {
            if (ModelState.IsValid)
            {
                etudiant.Role = "Etudiant";
        ...
        {
            int idEtudiant = int.Parse(Session["idE"].ToString());
            var m = db.Motes.Where(n => n.IdMatiere == id && n.IdEtudiant == idEtudiant).ToList();
            return View(m);
        }
